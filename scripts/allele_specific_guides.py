...
def find_unique_sgRNAs(sgrna_bed_1, sgrna_bed_2, min_distance=1):
    ...
    df1 = filtered_df[
        [
            ...
            "start_" + file1,
            "stop_" + file1,
            "id,sequence,pam,chromosome,position,sense_" + file1,
            "context_" + file1,
            "strand_" + file1,
            "sequence_" + file2,
            "context_" + file2,
            "hamming_dist",
            "context_hamming_dist",
        ]
    ]
    df1_renamedict = {
        "id,sequence,pam,chromosome,position,sense_" + file1: "id,sequence,pam,chromosome,position,sense",
        "context_" + file1: "context",
        "#chr_" + file1: "#chr",
        "start_" + file1: "start",
        "stop_" + file1: "stop",
        "strand_" + file1: "strand",
    }
    ...
    df2 = filtered_df[
        [
            ...
            "start_" + file2,
            "stop_" + file2,
            "id,sequence,pam,chromosome,position,sense_" + file2,
            "context_" + file2,
            "strand_" + file2,
            "sequence_" + file1,
            "context_" + file1,
    ...
    df2_renamedict = {
        "id,sequence,pam,chromosome,position,sense_" + file2: "id,sequence,pam,chromosome,position,sense",
        "context_" + file2: "context",
        "#chr_" + file2: "#chr",
        "start_" + file2: "start",
        "stop_" + file2: "stop",
        "strand_" + file2: "strand",
    }
...
if __name__ == "__main__":
    ...
    parser.add_argument(
        "-d", "--min_distance", type=int, default=1, help="Minimum Hamming distance to filter sgRNAs. Default is 1."
    )
