...
"CRISPR Cas12a guides, genome wide (bed9 + extra; off-targets in external bgzip tab file)"
    ...
    string  unique_TTTV;               "TTTV PAM unique"
    string  unique_TTTN;               "TTTN PAM unique"
    string  TTTV_enCas12a_specificity; "EnCas12a TTTV specificity"
    string  TTTN_enCas12a_specificity; "EnCas12a TTTN specificity"
    string  TTTV_AsCas12a_specificity; "AsCas12a TTTV specificity"
    string  TTTN_AsCas12a_specificity; "AsCas12a TTTN specificity"
    string  ascas12a_deepcpf1_score;   "AsCas12a-DeepCpf1"
    string  enseq_deepcpf1_score;      "EnCas12a-DeepCpf1"
    string  deepcpf1_score;            "DeepCpf1"
    string  enpam_gb_score;            "EnPAM-GB"
