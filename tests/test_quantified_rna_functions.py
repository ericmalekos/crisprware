...
from crisprware.utils.quantified_rna_functions import (
    process_kallisto,
    process_salmon,
    process_flair,
    process_mandalorian,
...
class TestProcessRNA(unittest.TestCase):
    ...
    def test_process_kallisto_2(self):
        kallisto_tpms = [
            "./tests/test_data/processed_rna_seq/kallisto/kallisto_abundance_1.tsv",
    ...
    def test_process_salmon_2(self):
        salmon_tpms = [
            "./tests/test_data/processed_rna_seq/salmon/salmon_quant_1.sf",
    ...
    def test_process_mandalorian_2(self):
        mandalorian_tpms = [
            "./tests/test_data/processed_rna_seq/mandalorian/mandalorian_isoforms_1.filtered.clean.tpm",
